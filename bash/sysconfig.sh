...
function error-message {
 echo "Warning: Error sent to stderr" >&2
}
...
function displayhelp {
 echo "For help please use: -h or --help"
 echo "Valid Arugments:--host, --domain, --ipconfig, --os, --cpu, --memory, --disk, --printer"
}
...
function cleanup {
 rm -f /tmp/*info.* 
 echo "Temp script files deleted"
}
trap cleanup SIGINT
